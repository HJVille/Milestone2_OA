...
public class PasswordHashService {
    ...
    public boolean matches(String candidatePassword, String storedValue) {
        if (candidatePassword == null || storedValue == null) {
            return false;
        }
        if (!isHashed(storedValue)) {
            return storedValue.equals(candidatePassword);
        }
        ...
        try {
            ...
            byte[] actual = derive(candidatePassword.toCharArray(), salt, iterations, expected.length * 8);
